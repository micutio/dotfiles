local cfg = {
  ...
  move_signature_window_key = {'<M-k>', '<M-j>', '<M-h>', '<M-l>'}, -- move the floating window, e.g. {'<M-k>', '<M-j>'} to move up and down, or
...
-- Expose config so lsp.lua can pass it to on_attach in LspAttach (per-buffer).
_G.lsp_signature_cfg = cfg
